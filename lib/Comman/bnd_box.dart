// ignore_for_file: no_leading_underscores_for_local_identifiers, prefer_typing_uninitialized_variables, avoid_function_literals_in_foreach_calls
        ...
        var list = re["keypoints"].values.map<Widget>((k) {
          ...
          return Positioned(
              ...
              child: Text(
                "● ${k["part"]}",
                style: const TextStyle(
                    color: AppColors.PRIMERY_COLOR, fontSize: 12.0),
              ));
        }).toList();
